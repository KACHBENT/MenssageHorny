                ...
                <!-- Usuarios de prueba (solo para desarrollo)
                        <div class="mt-4 pt-3 border-top">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <button class="btn btn-sm btn-outline-success test-user" data-email="chris@whatsapp.com"
                                    data-pass="12345678">
                                    Chris Admin
                                </button>
                                <button class="btn btn-sm btn-outline-success test-user" data-email="ana@example.com"
                                    data-pass="12345678">
                                    Ana García
                                </button>
                                <button class="btn btn-sm btn-outline-success test-user" data-email="carlos@example.com"
                                    data-pass="12345678">
                                    Carlos López
                                </button> -->
            </div>
